...
function AllHeroProducts() {
  ...
  useEffect(() => {
    ...
    axios.get(`${url}/product/heroproducts`).then((res) => {
  ...
  function handeldeDelete(ProductId){
    ...
    axios.delete(`${url}/product/heroproducts`, {data}).then((res) => {
  ...
  return (
    <>
    {AllHeroProductsData && AllHeroProductsData.map((row) => (
      ...
      <CardActionArea component="a" href="#">
        ...
        <Card sx={{ display: 'flex' }}>
          ...
          <CardContent sx={{ flex: 1 }}>
            ...
            <Button onClick={(e)=>handeldeDelete(row.heroproductid)} variant="outlined" color="error">
                Delete
              </Button> 
            </Typography>
