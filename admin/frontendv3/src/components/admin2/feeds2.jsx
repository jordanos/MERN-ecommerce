...
// Axios 
  ...
  return (
    ...
    {Variablefeed.map((feeds) => (       
        <Card sx={{ maxWidth: 300, maxHeight: 600,marginRight: '5%', marginTop:'2%', float:'right' }}>
            <CardHeader
                avatar={<Button onClick={(e)=>handeldeDelete(feeds.feedid)} variant="outlined" color="error">
                Delete
              </Button>}
                title={feeds.fullname}
               
                subheader={<Timestamp relative date={feeds.date } /> }  ><Button onClick={(e)=>handeldeDelete()} variant="outlined" color="error">
                Delete
              </Button></CardHeader>
            ...
            {feeds.image && feeds.image!='' && <CardMedia
                component="img"
                height="300"
                // const dates = 
                image={feeds.image[0]}
